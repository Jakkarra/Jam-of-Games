...
namespace HAPISPACE {
	...
	*/
	...
	struct HAPI_TColour final
	{
		...
		// Helpers
		static HAPI_TColour BLACK() { return HAPI_TColour(0); }
		static HAPI_TColour WHITE() { return HAPI_TColour(255); }		 
		static HAPI_TColour RED() { return HAPI_TColour(255, 0, 0);}
		static HAPI_TColour GREEN() { return HAPI_TColour(0, 255, 0);}
		static HAPI_TColour BLUE() { return HAPI_TColour(0, 0, 255);}
		static HAPI_TColour YELLOW() { return HAPI_TColour(255, 255, 0); }
		static HAPI_TColour CYAN() { return HAPI_TColour(0, 255, 255); }
		static HAPI_TColour MAGENTA() { return HAPI_TColour(255, 0, 255); }
		static HAPI_TColour HAPI() { return HAPI_TColour(36, 36, 251); }
